...
<div style="padding: 60px 80px 40px;">
    ...
    <img src='{{asset("images/frame.png")}}' style="position: absolute; top: -30px; left: -20px; width: 135%; height: 1000px; margin: 0;" />
    ...
    <p>Место составления векселя: г. Алматы, мкрн. Алмагуль, дом 9, кв. 144</p>
